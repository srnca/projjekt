  ...
  return (
    <section className="tc-testimonials-style2">
      <div className="container">
                ...
                <SwiperSlide>
                  <div className="slider-card">
                    <div className="img">
                      ...
                      />
                      <img
                        src="/assets/img/testimonials/testi_shap1.png"
                        alt=""
                        className="shap1"
                      />
                      <img
                        src="/assets/img/testimonials/testi_shap2.png"
                        alt=""
                        className="shap2"
                      />
                    </div>
        ...
        <div className="logos">
          <a href="#">
            <img src="/assets/img/clients/cl1.svg" alt="" />
          </a>
          <a href="#">
            <img src="/assets/img/clients/cl2.svg" alt="" />
          </a>
          <a href="#">
            <img src="/assets/img/clients/cl3.svg" alt="" />
          </a>
          <a href="#">
            <img src="/assets/img/clients/cl4.svg" alt="" />
          </a>
          <a href="#">
            <img src="/assets/img/clients/cl5.svg" alt="" />
          </a>
        </div>
      </div>
    </section>
